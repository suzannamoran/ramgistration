...
## 3. Website Design
Wireframed and developed a protype website in Adobe XD for a final submission.

https://xd.adobe.com/view/9c9732e9-0f59-4be7-8945-85cb2d86df11-c9c4/

## 4. Created a Dictionary of Prerequisites for Each Course
Using the BeautifulSoup library, scraped data from the UNC course catalog about required prerequisites for each course, then transferred that data to a dictionary.
...
* Another API use would be scholarship searching. After a student enters in their major and minor(s), they can navigate to a list of current scholarships that are applicable to their field. They can choose to sort this by prize or due date.
